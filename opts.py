...
def parse_opt():
    ...
    parser.add_argument(
        "--gpus", type=str, default="0", help="set CUDA_VISIBLE_DEVICES"
    )
    # Data input settings
    parser.add_argument(
        "--input_json",
    ...
    parser.add_argument(
        "--input_fc_dir",
        type=str,
        default="data/cocobu_fc",
        help="path to the directory containing the preprocessed fc feats",
    )
    parser.add_argument(
        "--input_att_dir",
        type=str,
        default="data/cocobu_att",
        help="path to the directory containing the preprocessed att feats",
    )
    parser.add_argument(
        "--input_label_h5",
        type=str,
        default="data/cocotalk_label.h5",
    ...
    # Model settings
    parser.add_argument(
        "--caption_model", type=str, default="vsua", help="model type: [vsua]"
    )
    parser.add_argument(
        "--rnn_size",
        type=int,
    ...
    parser.add_argument(
        "--use_box", type=str2bool, default=False, help="If use box features"
    )
    parser.add_argument(
        "--norm_box_feat",
        type=int,
    ...
    parser.add_argument(
        "--sg_geometry_dir",
        type=str,
        default="data/geometry-iou0.2-dist0.5-undirected/",
        help="directory of geometry edges and features",
    )
    parser.add_argument(
        "--sg_box_info_path",
        type=str,
        default="data/vsua_box_info.pkl",
    ...
    parser.add_argument("--rela_gnn_type", type=int, default=0, help="rela gcn type")
    parser.add_argument(
        "--sg_label_embed_size",
        type=int,
        default=128,
